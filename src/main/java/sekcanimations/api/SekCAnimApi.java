 ...
 *
 * Also use Loader.isModLoaded("sekcanims") or the SekCAnimApi.isloaded() and dont just keep calling the methods taking advantage
 ...
 * Basically the name is too generic.
  */
public final class SekCAnimApi {
